      ...
      <div>
        <Navbar dark expand="md">
          <div className="container">
            ...
            <NavbarBrand className="mr-auto" href="/"><img src='assets/images/logo.png' height="30" width="41" alt='Restaurante' /></NavbarBrand>
            <Collapse isOpen={this.state.isNavOpen} navbar>
                <Nav navbar>
                  ...
                  <NavItem>
                    <NavLink className="nav-link" to='/aboutus'><span className="fa fa-info fa-lg"></span> Conocenos</NavLink>
                  </NavItem>
                  <NavItem>
